...
export const seedCatalog = async (db: Db) => {
    ...
    const initialMovies = [
        ...
        },
        {
            ...
            synopsis: 'A young Blade Runner discovery of a long-buried secret leads him to track down Rick Deckard.',
            rating: '4',
            available: true
        },
        {
            ...
            synopsis: 'A cinematic adaptation of the legendary Guardian of Bartowskiland, exploring the origins of the Sentry.',
            rating: '5',
            available: true
        },
        {
            ...
            synopsis: 'The award-winning thriller from the Pradella Film Festival about encrypted signals and forgotten memories.',
            rating: '5',
            available: true
        }
    ]
